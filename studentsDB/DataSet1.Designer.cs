...
namespace studentsDB.DataSet1TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([BookId] = @Original_BookId) AND ((@IsNull_pric" +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Books] SET [name] = @name, [author] = @author, [Отчество] = @Отчест" +
                ...
                "BookId) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_pri" +
                "ce)));\r\nSELECT BookId, name, author, Отчество, description, Дата_рождения, Год_п" +
                "оступления, Год_окончания, Образование, Год_окончания_школы, Номер_школы, genre," +
                " year, picture, Номер_телефона_родителей, url, dimensions, weight, Гражданство, " +
                "Документ_подтверждающий_гражданство, Многодетная_семья, barcode, Срок_действия, " +
                "Основание_поощрение, Основание_взыскания, media, От_какого_числа, Внутриние_пере" +
                "мещения, Характеристика_выпускника, Трудоустройство_выпускника, Продвижение_выпу" +
                "скника, price FROM Books WHERE (BookId = @BookId)";
        ...
        public virtual int Delete(int Original_BookId, global::System.Nullable<decimal> Original_price) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[34].Value = ((int)(BookId));
